...
interface LinkProps{
    ...
    const [links, setLinks ] = useState<LinkProps[]>([])
        ...
        .catch((error) => {
            console.log("ERROR AO CADASTRAR MO BANCO " + error)
        })
    }
    ...
    return(
        <div className="flex items-center flex-col min-h-screen pb-7 px-2">
            ...
            <form className="flex flex-col mt-3 mb-3 w-full max-w-x1"onSubmit={handleRegister}>
            ...
            <section className="flex my-4 gap-5">
                ...
                {nameInput !== '' && (
                    ...
                    >
                        ...
                        <p className="font-mediu" style={{color: textColorInput}}>{nameInput}</p>
                    </article>
                    </div>
                )}
            ...
            <h2 className="font-bold text-white mb-4 text-2xl">
                ...
                {links.map((link) => (
                    ...
                    >
                        ...
                        <div>
                            <button 
                            className="border border-dashed p-1 bg-neutral-800 rounded"
